...
const defaultContent: FooterContent = {
  tagline: "Your Trusted Mobile Partner in Chickballapur.",
              ...
              <div className="relative rounded-[28px] liquid-glass p-2 shadow-2xl">
                <div className="relative aspect-[9/19] w-full overflow-hidden rounded-2xl bg-black">
                  ...
                  <LazyVideo
                    ...
                    muted={true}
                    playsInline={true}
                    aria-label="Sri Tele Links app preview - approvals made easy"
                  />
                  {/* On-screen content */}
                ...
                <ul className="space-y-2 text-sm text-neutral-300">
                  <li className="flex items-center gap-2">
                    ...
                    <a
                      ...
                      aria-label="Follow Sri Tele Links on X/Twitter"
                    >
                      X/Twitter
                    </a>
                  </li>
                  <li className="flex items-center gap-2">
                    ...
                    <a
                      ...
                      rel="noopener noreferrer"
                      className="hover:text-lime-300"
                      aria-label="Sri Tele Links on YouTube"
                    >
                      YouTube
                    </a>
                  </li>
                  <li className="flex items-center gap-2">
                    ...
                    <a
                      ...
                      rel="noopener noreferrer"
                      className="hover:text-lime-300"
                      aria-label="Follow Sri Tele Links on Instagram"
                    >
                      Instagram
                    </a>
                  </li>
                  <li className="flex items-center gap-2">
                    ...
                    <a
                      ...
                      rel="noopener noreferrer"
                      className="hover:text-lime-300"
                      aria-label="WhatsApp Sri Tele Links"
                    >
                      WhatsApp
                    </a>
                  </li>
